...
def order_metric(df1):
    """Esta função tem a responsabilidade de retornar uma figura de gráfico de linhas
        Orders by Day
        Input: Dataframe
        Output: fig
     """
...
def traffic_order_share(df1):
    """Esta função tem a responsabilidade de retornar uma figura de gráfico de pizza
        Traffic Order Share
        Input: Dataframe
        Output: fig
     """
...
def traffic_order_city(df1):
    """Esta função tem a responsabilidade de retornar uma figura de gráfico de dispersão
        Traffic Order City
        Input: Dataframe
        Output: fig
    """
...
def order_by_week(df1):
    """Esta função tem a responsabilidade de retornar uma figura de gráfico de linha
       Order By Week
       Input: Dataframe
       Output: fig
     """
...
def country_map(df1):
    """Esta função tem a responsabilidade de retornar uma figura de gráfico de mapa
       Country Map
       Input: Dataframe
       Output: fig
     """
